...
import ru.kors.giftstore.config.jwt.JWTTokenFilter;
...
public class WebSecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3000", "https://example.com")); // Replace with your frontend's origin(s)
